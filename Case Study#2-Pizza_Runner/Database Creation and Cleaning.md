...
--1. customer_orders : replace all the values which are blank/'null' by NULL in the exclusions and extras columns.
select 
order_id, 
customer_id,
pizza_id, 
...
--2. runners_orders: replace all the values which are blank/null by NULL in the distance, cancellation,pickup and distance columns; eliminate the unnecessary information 
--from the distance and duration columns such as km and minutes. 
